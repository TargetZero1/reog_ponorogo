      ...
      <div className="py-12 md:py-16 bg-gradient-to-b from-white via-neutral-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-red-950 mb-4">Acara Budaya & Pertunjukan</h1>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Saksikan kemegahan pertunjukan Reog Ponorogo dan acara budaya lainnya
            </p>
              ...
              >
                ...
                <div className="h-48 bg-gradient-to-br from-red-600 via-amber-500 to-red-700 relative overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-sm rounded-lg px-3 py-1">
                    {Number(e.price) > 0 ? (
                      <span className="text-white font-bold text-sm">Rp {Number(e.price).toLocaleString('id-ID')}</span>
                    ) : (
                      <span className="text-white font-bold text-sm">Gratis</span>
                    )}
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      ...
                      <span>{e.date ? new Date(e.date).toLocaleDateString('id-ID', { 
                        weekday: 'long', 
                        year: 'numeric', 
                        month: 'long', 
                        day: 'numeric' 
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      ...
                      <span className="line-clamp-1">{e.location || 'Lokasi TBA'}</span>
                    </div>
                  </div>

                  <p className="text-sm text-gray-700 line-clamp-3 mb-4 leading-relaxed">
                    {e.description || 'Acara budaya dan pertunjukan Reog Ponorogo yang menarik.'}
                  </p>

                  {/* Actions */}
                  <div className="flex gap-3 pt-4 border-t border-neutral-200">
                    <a 
                      href={route('events.show', e.slug || e.id)} 
          ...
          {events.data.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-500">Acara akan segera diumumkan. Silakan kembali lagi nanti.</p>
            </div>
          )}
        </div>
      </div>
