import { MapPin, Clock, Camera, Star, X, Navigation, Phone, Ticket } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative h-80 overflow-hidden rounded-t-3xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <h2 className="text-white mb-2">{selectedData.name}</h2>
            ...
            <div className="p-8">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {selectedData.facilities.map((facility, idx) => (
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-amber-500 to-amber-600 text-red-950 py-4 rounded-xl hover:from-amber-400 hover:to-amber-500 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <Navigation size={20} />
                  Petunjuk Arah
                </button>
                ...
                <button
                  onClick={() => {
                    // Open booking/register page with prefilled attraction name
                    const target = `/pesan-ticket/register?attraction=${encodeURIComponent(selectedData.name)}`;
                    window.location.href = target;
                  }}
                  className="flex-1 bg-gradient-to-r from-red-600 to-red-700 text-white py-4 rounded-xl hover:from-red-700 hover:to-red-800 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <Phone size={20} />
                  Pesan Ticket
                </button>
      ...
      <div className="bg-gradient-to-br from-red-950 to-red-800 rounded-2xl p-8 md:p-12 text-center shadow-2xl">
        <div className="max-w-3xl mx-auto">
          ...
          <h3 className="text-white mb-4">Mudah Diakses dari Berbagai Kota</h3>
          
          <p className="text-amber-50/90 mb-8 leading-relaxed">
            Ponorogo terletak di Jawa Timur dengan akses mudah dari kota-kota besar. 
            Hanya 2 jam dari Madiun, 4 jam dari Surabaya, dan 5 jam dari Yogyakarta.
          </p>

          <div className="grid sm:grid-cols-3 gap-6 mb-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-amber-400 mb-2">210 km</div>
              <div className="text-white">dari Surabaya</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-amber-400 mb-2">40 km</div>
              <div className="text-white">dari Madiun</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-amber-400 mb-2">190 km</div>
          ...
          <button
            ...
            className="w-full sm:w-auto bg-amber-500 text-red-950 px-8 py-4 rounded-lg hover:bg-amber-400 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            Lihat Peta Lengkap
          </button>
        </div>
